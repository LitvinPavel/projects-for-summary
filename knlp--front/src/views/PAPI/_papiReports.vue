  ...
  <v-card>
    ...
    <v-window v-model="step">
      ...
      <v-window-item :value="3">
        <report v-if="step === 3" :dialog="true"></report>
      </v-window-item>
    </v-window>
    <v-divider></v-divider>
    <v-card-actions>
...
<script>
  import InputSearchData from '../../components/PAPI/reports/InputSearchData.vue'
  import SearchResult from '../../components/PAPI/reports/SearchResult.vue'
  import Report from '../../components/PAPI/reports/Report.vue'
